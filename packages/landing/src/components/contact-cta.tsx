  ...
  return (
    <SectionWrapper id="contact" alternate>
      <div className="text-center mb-16">
        ...
        <p className="mt-4 text-lg text-gray-400">{dict.contact.subtitle}</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* WhatsApp CTA */}
        <div className="bg-gradient-to-br from-brand/20 to-brand/5 border border-brand/30 rounded-2xl p-8 md:p-10">
          ...
          <div className="bg-surface-card border border-border-subtle rounded-2xl p-6">
            ...
            <div className="flex gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 bg-surface-2 px-4 py-2.5 rounded-xl text-gray-300 hover:text-brand hover:border-brand/50 border border-border-subtle transition-colors"
              >

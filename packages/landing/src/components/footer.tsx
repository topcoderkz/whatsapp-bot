    ...
    <footer className="bg-surface-1 border-t border-border-subtle">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {/* Brand */}
          <div>
            <img src="/images/logo-192.png" alt="100% Fitness Gym" className="h-14 w-14 rounded-full" />
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm text-gray-400">
              <a href={getWhatsAppUrl(locale)} target="_blank" rel="noopener noreferrer" className="hover:text-brand transition-colors">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href={getWhatsAppUrl(locale)} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-brand transition-colors" aria-label="WhatsApp">
